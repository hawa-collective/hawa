...
export const metadata = {
  title: "404 Error - The Hawa Collective",
};
const Pricing = () => {
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-xxl-6 col-lg-7 m-auto">
              <h3>Opps! Seems you’re in the wrong place.</h3>
              <p className="me-xxl-5 ms-xxl-5 pt-15 pb-20">
              Can not find what you need? Use the main menu
              or start from our Homepage below.
              </p>
              <Link href="/" className="btn-twentyOne fw-500 tran3s futura_button">
                Back to home
              </Link>
            </div>
          </div>
