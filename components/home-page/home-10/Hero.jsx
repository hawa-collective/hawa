  ...
  return (
    <div className="container">
      ...
      <div className="card-one shapes bg-white">
        ...
        <h6 className="fw-500 tx-dark mb-15 font-eustache hero_cta_font">Discover more of Hawa on Instagram.</h6>
        <a href="https://www.instagram.com/hawacollective/" target="_blank" className="more-btn tran3s text-uppercase fw-500 fs-13">
          Learn More
        </a>
      </div>
      {/* End card-one */}
