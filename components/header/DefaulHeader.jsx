        ...
        <div className="d-flex align-items-center justify-content-between">
          ...
          <div className="right-widget ms-auto d-flex align-items-center order-lg-3">
            ...
            {/* <Link
              ...
              className="btn-twentyOne fw-500 tran3s d-none d-lg-block font-lemon-yellow"
            >
              Contact us
            </Link> */}
            <Link
              href="#login"
              className="btn-twentyOne fw-500 tran3s d-none d-lg-block font-lemon-yellow med_link_font"
            >
              Login
            </Link>
          </div>{" "}
